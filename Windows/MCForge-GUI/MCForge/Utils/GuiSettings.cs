...
namespace MCForge.Gui.WindowsAPI.Utils {
    ...
    public class GuiSettings {
        ...
        public const string SHOW_NEWS_KEY = "ShowNews";
        ...
        private static readonly SettingNode[] defaultValues = {
            ...
            new SettingNode(SHOW_NEWS_KEY, "true", "Show news on startup" ),
        ...
        /// </summary>
        public static event EventHandler<SettingsChangedEventArgs> OnSettingChanging;
        ...
        public static int GetSettingInt(string key) {
            ...
            if ( !int.TryParse(GetNode(key).Value, out i) ) {
                Logger.Log("GuiSettings: integer expected as first value for '" + key + "'", Color.Red, Color.Black);
                return -1;
            }
            return i;
        }
        ...
        public static void Save() {
            ...
            using ( var writer = new StreamWriter(File.Create(FileUtils.PropertiesPath + "gui.properties")) ) {
                foreach ( var v in Values ) {
